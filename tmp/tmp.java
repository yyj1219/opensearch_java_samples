...
public class EndUserTxESRD implements IEndUserTxRD {
  ...
  /*  public  List<Map<String, Object >> LoadEndUserXLogInfo2(XLogInfoSearchArgs args) {
        try {
            ...
            RestHighLevelClient client = ConnectionManager.getInstance().getClient();
            ...
            while (searchHits != null && searchHits.length > 0 && readContinue) {
                for(int i = 0; i < searchHits.length; i++) {
                    if(maxCount++ > conf.xlog_list_result_max_count) {
                        readContinue = false;
                        break;
                    }
                    ...
                    for(DocumentField field : searchHits[i].getFields().values()) {
                        ...
                        if(fieldName.equals("serviceHash")) {
                            valueMap.put(fieldName, textReader.getString(TextTypes.SERVICE, Long.valueOf(field.getValue().toString())));
                        } else if( (fieldName.equals("countryCode")) || (fieldName.equals("objName")) || (fieldName.equals("pageId")) || (fieldName.equals("userIp")) || (fieldName.equals("uuid")) ){
                            valueMap.put(fieldName, field.getValue().toString());
                        } else if(fieldName.equals("errorHash")){
                            if(((Number)field.getValue()).longValue() != 0) {
                                valueMap.put(fieldName,"Y");
                            } else {
                                valueMap.put(fieldName,"N");
                            }
                        } else {
                            valueMap.put(field.getName(), field.getValue());
                        }
                    }
                    if(valueMap.containsKey("elapsedTime") && valueMap.containsKey("endTime")){
                        valueMap.put( "startTime", Long.parseLong(valueMap.get("endTime").toString()) - Long.parseLong(valueMap.get("endTime").toString()) );
                    }
...
//                QueryUtil.printHistogramResultSet(resultList,"time");
            }
...
*/
    ...
    public static void testSearchXLog() {
        XLogInfoSearchArgs args = new XLogInfoSearchArgs();
        args.from = DateUtil.getTime("2019-07-05 11:50:00","yyyy-MM-dd HH:mm:ss.ZZZ");
        args.to = DateUtil.getTime("2019-07-05 11:55:00","yyyy-MM-dd HH:mm:ss.ZZZ");
//        fromTime: 1562295845000
//        toTime: 1562295865473
        args.from = 1562300201771L;
        args.to = 1562300225855L;
        args.objList.add(-2070370268);
        args.objList.add(-1987651485);
        args.objList.add(-2008362383);
//        args.fileterMap.put("error", null);
        args.fromElapsed=0;
        args.toElapsed=3000;

        //new RealtimeCounterESRD().LoadXLogInfo(args);
//        new EndUserXLogESRD().LoadXLogInfo(args);
    }

    public static void testLoadTopNTx() throws Exception {

        TopTxSearchArgs args = new TopTxSearchArgs();
        args.from=1558537200000L;
        args.to = 1558623599000L;
        args.objList.add(1715778397);
        args.objList.add(-1987651485);
        args.objList.add(-2070370268);
//        args.top =10;
//        args.kind = 1;  // 1: elapsed, 2 : call , 3. error
        System.out.println( new EndUserTxESRD().LoadEndUserTopNTransaction(args) );
    }

    public static void test1() throws IOException {
        BulkRequest bulkRequest = new BulkRequest();
        XLogPack p = new XLogPack();
        p.endTime = 1558533600000L;
        p.objHash=1233;
        IndexRequest indexRequest = new IndexRequest(String.format("xlog-info-%s",DateUtil.yyyymmdd_utc(p.endTime)));
        XContentBuilder builder = jsonBuilder().startObject()
                .field("objHash", p.objHash)
                .field("endTime", p.endTime);
        builder.endObject();
        bulkRequest.add(indexRequest.source(builder));

        p = new XLogPack();
        p.endTime = 1558620000000L;
        p.objHash=1233;
        indexRequest = new IndexRequest(String.format("xlog-info-%s",DateUtil.yyyymmdd_utc(p.endTime)));
        ...
        ConnectionManager.getInstance().getWriteClient().bulk(bulkRequest, RequestOptions.DEFAULT );
    }

    public static void testLoadTxRestHisto() throws  Exception {
        long from = DateUtil.getTime("2019-05-21 00:00:01","yyyy-MM-dd HH:mm:ss");
        long to = DateUtil.getTime("2019-05-21 23:00:01","yyyy-MM-dd HH:mm:ss");
        XLogInfoSearchArgs args = new XLogInfoSearchArgs();
        args.from = from;
        args.to = to;
        args.objList.add(-2070370268);
        args.serviceHash=-1889428097L;
        new EndUserTxESRD().LoadEndUserTimeHisto2(args);
    }

    public static void testLoadXLogHistgram() throws Exception {
        long from = DateUtil.getTime("2019-07-15 15:30:00","yyyy-MM-dd HH:mm:ss");
        long to = DateUtil.getTime("2019-07-15 16:30:00","yyyy-MM-dd HH:mm:ss");        //  7min
        System.out.println("from : " +from);
        System.out.println("to : " +to);
        XLogInfoSearchArgs args = new XLogInfoSearchArgs();
        args.from = from;
        args.to = to;
        args.objList.add(-1782861358);
        args.objList.add(-1122427380);
        args.objList.add(274289730);
        args.fromElapsed=0;
        args.toElapsed=1000;

        new EndUserTxESRD().LoadEndUserXLogHistogram(args);
    }

    public static void testLoadEndUserTopNTransaction() throws Exception {
        long from = DateUtil.getTime("2019-07-15 15:30:00","yyyy-MM-dd HH:mm:ss");
        long to = DateUtil.getTime("2019-07-15 16:30:00","yyyy-MM-dd HH:mm:ss");        //  7min
        System.out.println("from : " +from);
        System.out.println("to : " +to);
        TopTxSearchArgs args = new TopTxSearchArgs();
        args.from = 1563770366262L;
        args.to = 1563777566262L;
        args.objList.add(-1782861358);
        args.objList.add(-1122427380);
        args.objList.add(274289730);

        new EndUserTxESRD().LoadEndUserTopNTransaction(args);
    }

    public static void testLoadEndUserTimeHisto() throws Exception {
        long from = DateUtil.getTime("2019-07-17 15:00:00","yyyy-MM-dd HH:mm:ss");
        long to = DateUtil.getTime("2019-07-17 20:00:00","yyyy-MM-dd HH:mm:ss");
        System.out.println("from : " +from);
        System.out.println("to : " +to);
        XLogInfoSearchArgs args = new XLogInfoSearchArgs();
        args.from = 1563780228000L;
        args.to = 1563866628000L;
        args.objList.add(-1782861358);
        args.serviceHash = -836368442;

        new EndUserTxESRD().LoadEndUserTimeHisto(args);
    }

    public static void testLoadEndUserTimeHistoByInstance() throws Exception {
        long from = DateUtil.getTime("2019-07-22 15:00:00","yyyy-MM-dd HH:mm:ss");
        long to = DateUtil.getTime("2019-07-23 15:00:00","yyyy-MM-dd HH:mm:ss");
        System.out.println("from : " +from);
        System.out.println("to : " +to);
        XLogInfoSearchArgs args = new XLogInfoSearchArgs();
        args.from = from;
        args.to = to;
        args.objList.add(-1782861358);
        args.type = Byte.valueOf("11");

        new EndUserTxESRD().LoadEndUserTimeHistoByInstance(args);
    }

    public static void testLoadEndUserXLogInfo() throws Exception {
        long from = DateUtil.getTime("2023-03-20 11:00:00","yyyy-MM-dd HH:mm:ss");
        long to = DateUtil.getTime("2023-03-20 13:00:00","yyyy-MM-dd HH:mm:ss");
        System.out.println("from : " +from);
        System.out.println("to : " +to);
        XLogInfoSearchArgs args = new XLogInfoSearchArgs();
        args.from = 1563347293000L;
        args.to = to;
        args.objList.add(-1782861358);
        args.fromElapsed = 0;
        args.toElapsed = -1;

        new EndUserTxESRD().LoadEndUserXLogInfo(args);
    }
    ...
    public static void main(String[] args)  {
        try {
            ...
            //  XLog
            testLoadXLogHistgram();

            //  TopN
//            testLoadEndUserTopNTransaction();

            //  Time (Page/Xhr)
//            testLoadEndUserTimeHisto();

            //  Time by Instance
//            testLoadEndUserTimeHistoByInstance();

            //  XLog Detail List
//            testLoadEndUserXLogInfo();
