...
import tuna.server.db.rd.IEndUserSessionRD;

import java.io.IOException;
import java.util.List;

public class EndUserSessionESRD implements IEndUserSessionRD {
    @Override
    public long getSessionCount(long startTime, long endTime) {
        List<String> timeList = DateUtil.getSearchRangeTime("enduser-session-", startTime, endTime);
        if (timeList == null) {
            return 0;
        }
